...
export const IconsSprite = () => (
  <svg style={{ display: 'none' }} xmlns='http://www.w3.org/2000/svg'>
    <symbol id='icon-AddPlus' viewBox='0 0 24 24'>
      <title>Add-plus SVG Icon</title>
      <path
        fill='none'
        stroke='currentColor'
        strokeLinecap='round'
    ...
    <symbol id='icon-Appearance' viewBox='0 0 16 16'>
      <title>Appearance SVG Icon</title>
      <path
        fill='currentColor'
        fillRule='evenodd'
    ...
    <symbol id='icon-Arrow' viewBox='0 0 24 24'>
      <title>Arrow-ios-forward-outline SVG Icon</title>
      <path
        fill='currentColor'
    ...
    <symbol id='icon-Chats' viewBox='0 0 256 256'>
    ...
    <symbol id='icon-Circle' viewBox='0 0 24 24'>
      <title>Dummy-circle-small SVG Icon</title>
      <path
        fill='none'
        stroke='currentColor'
        strokeLinecap='round'
        strokeLinejoin='round'
        strokeWidth='2'
        d='M12 8a4 4 0 1 0 0 8a4 4 0 0 0 0-8'
      />
    </symbol>
    <symbol id='icon-ContactHeart' viewBox='0 0 2048 2048'>
      <title>Contact-heart SVG Icon</title>
      <path
        fill='currentColor'
    ...
    <symbol id='icon-CopyText' viewBox='0 0 24 24'>
    ...
    <symbol id='icon-Delete' viewBox='0 0 16 16'>
      <title>Delete-16-regular SVG Icon</title>
      <path
        fill='currentColor'
    ...
    <symbol id='icon-Forward' viewBox='0 0 24 24'>
      <title>Arrow-forward-thick SVG Icon</title>
      <path
        fill='none'
        stroke='currentColor'
        strokeLinecap='round'
    ...
    <symbol id='icon-FullscreenExit' viewBox='0 0 512 512'>
      <title>Fullscreen-exit SVG Icon</title>
      <path
        fill='#ffffff'
        d='M204 181.372L38.628 16H16v22.628L181.372 204H44v32h192V44h-32zM326.628 304H464v-32H272v192h32V326.628L473.372 496H496v-22.628z'
      />
    </symbol>
    ...
    <symbol id='icon-Notification' viewBox='0 0 24 24'>
      <title>Notification-on-outline SVG Icon</title>
      <path
        fill='currentColor'
    ...
    <symbol id='icon-Passkey' viewBox='0 0 20 21'>
      <title>Person-passkey-20-regular SVG Icon</title>
      <path
        fill='currentColor'
        d='M10 2a4 4 0 1 0 0 8a4 4 0 0 0 0-8M7 6a3 3 0 1 1 6 0a3 3 0 0 1-6 0m-1.991 5A2 2 0 0 0 3 13c0 1.691.833 2.966 2.135 3.797C6.417 17.614 8.145 18 10 18s3.583-.386 4.865-1.203q.143-.091.278-.19v-1.33a4 4 0 0 1-.816.676C13.257 16.636 11.735 17 10 17s-3.257-.364-4.327-1.047C4.623 15.283 4 14.31 4 13c0-.553.448-1 1.009-1h8.264a4 4 0 0 1-.13-1zm8.99 0a3 3 0 0 0 1.917 2.798l.084.031v5.029c0 .1.035.196.098.272l.599.728c.162.197.459.21.637.028l1.534-1.565a.43.43 0 0 0-.02-.62L17.5 16.5l1.351-1.177a.43.43 0 0 0 0-.646l-.939-.818A3.001 3.001 0 0 0 17 8a3 3 0 0 0-3 3m4-1a1 1 0 1 1-2 0a1 1 0 0 1 2 0'
      />
    </symbol>
    ...
    <symbol id='icon-Reply' viewBox='0 0 24 24'>
      ...
      <g fill='none'>
        <path
          d='M2 10.981L8.973 2v4.99c11.952 0 13.316 9.688 12.984 15.01l-.007-.041c-.502-2.685-.712-6.986-12.977-6.986v4.99L2 10.98z'
          stroke='currentColor'
          strokeWidth='2'
          strokeLinecap='round'
          strokeLinejoin='round'
    ...
    <symbol id='icon-SaveAs' viewBox='0 0 24 24'>
    ...
    <symbol id='icon-Search' viewBox='0 0 17 48'>
    ...
    <symbol id='icon-Sessions' viewBox='0 0 24 24'>
      <title>Devices SVG Icon</title>
      <path
        fill='currentColor'
        d='M20 3H7c-1.103 0-2 .897-2 2v2H4c-1.103 0-2 .897-2 2v10c0 1.103.897 2 2 2h6c1.103 0 2-.897 2-2h8c1.103 0 2-.897 2-2V5c0-1.103-.897-2-2-2M9.997 19H4V9h6zm10-2H12V9c0-1.103-.897-2-2-2H7V5h13z'
      />
    </symbol>
    <symbol id='icon-Sound' viewBox='0 0 24 24'>
      ...
      <path
        ...
        stroke='currentColor'
        strokeWidth='2'
        d='M13 14H8.818a3.249 3.249 0 1 0 .403 6.472l.557-.07A3.678 3.678 0 0 0 13 16.754V7.39c0-1.619 0-2.428.474-2.987c.474-.56 1.272-.693 2.868-.96L18.7 3.05c.136-.022.204-.034.24.006c.037.04.02.106-.013.24l-.895 3.581c-.015.06-.023.09-.044.11c-.02.02-.05.026-.111.038L13 8'
      />
    </symbol>
    <symbol id='icon-SoundMaxFill' viewBox='0 0 24 24'>
      <title>Sound-max-fill SVG Icon</title>
      <g fill='none'>
        <path
          fill='#ffffff'
    ...
    <symbol id='icon-SoundMinFill' viewBox='0 0 24 24'>
      <title>Sound-min-fill SVG Icon</title>
      <g fill='none'>
        <path
          fill='#ffffff'
          d='M4.158 13.93a3.752 3.752 0 0 1 0-3.86a1.5 1.5 0 0 1 .993-.7l1.693-.339a.45.45 0 0 0 .258-.153L9.17 6.395c1.182-1.42 1.774-2.129 2.301-1.938C12 4.648 12 5.572 12 7.42v9.162c0 1.847 0 2.77-.528 2.962c-.527.19-1.119-.519-2.301-1.938L7.1 15.122a.45.45 0 0 0-.257-.153L5.15 14.63a1.5 1.5 0 0 1-.993-.7'
        ...
        <path
          ...
          strokeLinecap='round'
          strokeWidth='2'
          d='M14.536 8.464a5 5 0 0 1 .027 7.044'
        />
      </g>
    </symbol>
    <symbol id='icon-SoundMuteFill' viewBox='0 0 24 24'>
      <title>Sound-mute-fill SVG Icon</title>
      <g fill='none'>
        <path
          fill='#ffffff'
          d='M4.158 13.93a3.752 3.752 0 0 1 0-3.86a1.5 1.5 0 0 1 .993-.7l1.693-.339a.45.45 0 0 0 .258-.153L9.17 6.395c1.182-1.42 1.774-2.129 2.301-1.938C12 4.648 12 5.572 12 7.42v9.162c0 1.847 0 2.77-.528 2.962c-.527.19-1.119-.519-2.301-1.938L7.1 15.122a.45.45 0 0 0-.257-.153L5.15 14.63a1.5 1.5 0 0 1-.993-.7'
    ...
    <symbol id='icon-Wallpaper' viewBox='0 0 20 20'>
      <title>Wallpaper-20-regular SVG Icon</title>
      <path
        fill='#ffffff'
        d='M3 6a3 3 0 0 1 3-3h2.5a.5.5 0 0 1 0 1H6a2 2 0 0 0-2 2v2.5a.5.5 0 0 1-1 0zm8-2.5a.5.5 0 0 1 .5-.5H14a3 3 0 0 1 3 3v2.5a.5.5 0 0 1-1 0V6a2 2 0 0 0-2-2h-2.5a.5.5 0 0 1-.5-.5M3.5 11a.5.5 0 0 1 .5.5V14c0 .37.101.718.277 1.016l4.486-4.486a1.75 1.75 0 0 1 2.474 0l4.486 4.486C15.9 14.718 16 14.371 16 14v-2.5a.5.5 0 0 1 1 0V14a3 3 0 0 1-3 3h-2.5a.5.5 0 0 1 0-1H14c.37 0 .718-.101 1.016-.277l-4.486-4.486a.75.75 0 0 0-1.06 0l-4.486 4.486C5.282 15.9 5.629 16 6 16h2.5a.5.5 0 0 1 0 1H6a3 3 0 0 1-3-3v-2.5a.5.5 0 0 1 .5-.5m9-4a.5.5 0 1 0 0 1a.5.5 0 0 0 0-1m-1.5.5a1.5 1.5 0 1 1 3 0a1.5 1.5 0 0 1-3 0'
      />
    </symbol>
  </svg>
);
...
export const Icon: React.FC<IconProps> = ({ name, ...props }) => {
  ...
  return (
    <svg viewBox={staticViewBoxes[name]} {...props}>
      <use href={`#icon-${name}`} />
    </svg>
  );
};
...
export const iconsList = {
  ...
  Chats: 'icon-Chats',
  Circle: 'icon-Circle',
  ContactHeart: 'icon-ContactHeart',
  ...
  Sound: 'icon-Sound',
  SoundMaxFill: 'icon-SoundMaxFill',
