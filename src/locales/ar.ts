export default {
  ...
  login: {
    ...
    noTrustedDeviceNeedPassword:
      'Use email and password sign-in to use recovery.',
    ...
    recoveryCooldownBody:
      'We noted this sign-in without your trusted device. You can continue with an email code after the time below.',
